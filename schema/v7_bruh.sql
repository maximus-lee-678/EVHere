...
CREATE TABLE charger ( 
	...
	pv_voltage_in        DECIMAL(2) NOT NULL    ,
	pv_current_in        DECIMAL(2) NOT NULL    ,
	pv_voltage_out       DECIMAL(2) NOT NULL    ,
	pv_current_out       DECIMAL(2) NOT NULL    ,
...
CREATE TABLE charger_rate_historic ( 
	id                   CHAR(36) NOT NULL  PRIMARY KEY  ,
	id_charger           CHAR(36) NOT NULL    ,
...
CREATE TABLE charger_pv_historic ( 
	id                   CHAR(36) NOT NULL  PRIMARY KEY  ,
	id_charger           CHAR(36) NOT NULL    ,
	pv_voltage_in        DECIMAL(2) NOT NULL    ,
	pv_current_in        DECIMAL(2) NOT NULL    ,
