  ...
  return (
    ...
    <form class="w-full max-w-sm mx-auto mt-6" onSubmit={handleSubmit}>
      <div class="md:flex md:items-center mb-6">
        ...
        <div class="md:w-2/3">
          <input value={email} onChange={(event) => setEmail(event.target.value)} class="bg-gray-200 appearance-none border-2 border-gray-200 rounded w-full py-2 px-4 text-gray-700 leading-tight focus:outline-none focus:bg-white focus:border-cyan-500" id="inline-full-name" type="email" placeholder="jane@email.com" />
        </div>
      </div>
      <div class="md:flex md:items-center mb-6">
        <div class="md:w-1/3">
      ...
      <div class="md:flex md:items-center mb-6">
        ...
        <div class="md:w-2/3">
          <input value={phoneNumber} onChange={(event) => setPhoneNumber(event.target.value)} class="bg-gray-200 appearance-none border-2 border-gray-200 rounded w-full py-2 px-4 text-gray-700 leading-tight focus:outline-none focus:bg-white focus:border-cyan-500" id="inline-full-name" type="tel" placeholder="91234567" />
        </div>
      </div>
